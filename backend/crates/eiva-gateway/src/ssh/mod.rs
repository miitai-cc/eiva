...
//! - **OpenSSH subsystem mode**: Run as `eiva-gateway --ssh-stdio` subsystem
//!
//! ## Modes
//!
...
//!
//! ```bash
//! eiva-gateway --ssh-listen 0.0.0.0:2222
//! ```
//!
//! Clients connect with:
//! ```bash
//! eiva-tui --ssh user@host:2222
//! ```
//!
...
//!   User agent
//!   RequestTTY no
//!   RemoteCommand eiva-gateway --ssh-stdio
//! ```
//!
//! Or configure as a proper subsystem in `/etc/ssh/sshd_config`:
//! ```text
//! Subsystem eiva /usr/local/bin/eiva-gateway --ssh-stdio
//! ```
//!
//! ## Authentication
//!
...
///
/// This is used when running as `eiva-gateway --ssh-stdio`, typically
