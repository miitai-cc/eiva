...
pub(crate) enum GwEvent {
    ...
    ShowSecrets {
        secrets: Vec<eiva_view::SecretInfoData>,
        agent_access: bool,
        has_totp: bool,
    },
    /// Show skills info dialog.
    ShowSkills {
        skills: Vec<eiva_view::SkillInfoData>,
    },
    /// Show tool permissions info dialog.
    ShowToolPerms {
        tools: Vec<eiva_view::ToolPermInfoData>,
    },
    ...
    EngineListResult {
        engines: Vec<eiva_view::LocalEngineData>,
    },
    /// Engine model list result received.
    EngineModelListResult {
        engine: String,
        models: Vec<eiva_view::LocalModelData>,
    },
    ...
    CronListResult {
        jobs: Vec<eiva_view::CronJobData>,
    },
    ...
    UsageStatsResult {
        totals: eiva_view::UsageTotalsData,
        per_model: Vec<eiva_view::ModelUsageData>,
        per_session: Vec<eiva_view::SessionUsageData>,
    },
    ...
    HostInfo(eiva_view::HostInfoData),
    /// Current system load status received.
    LoadStatus(eiva_view::LoadStatusData),
    /// Service list received from gateway.
    ServiceList(eiva_view::ServiceListData),
    /// A single service was updated (start/stop/restart result).
    ServiceActionResult {
        service: Option<eiva_view::ServiceInfoData>,
    },
}
