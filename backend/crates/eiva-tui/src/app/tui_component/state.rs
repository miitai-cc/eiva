...
pub(super) struct Ui {
    ...
    pub hatching_dialog: State<eiva_view::HatchingDialogData>,
    pub show_pairing: State<bool>,
    pub pairing_step: State<eiva_view::PairingStep>,
    pub pairing_field: State<eiva_view::PairingField>,
    ...
    pub prompt_attachments: State<Vec<eiva_view::PromptAttachment>>,
    pub show_secrets_dialog: State<bool>,
    pub secrets_dialog_data: State<Vec<eiva_view::SecretInfoData>>,
    ...
    pub skills_dialog_data: State<Vec<eiva_view::SkillInfoData>>,
    ...
    pub tool_perms_dialog_data: State<Vec<eiva_view::ToolPermInfoData>>,
    pub tool_perms_selected: State<Option<usize>>,
    pub skills_scroll_offset: State<usize>,
    pub tool_perms_scroll_offset: State<usize>,
    pub host_info: State<Option<eiva_view::HostInfoData>>,
    pub load_status: State<Option<eiva_view::LoadStatusData>>,
    pub show_system_info: State<bool>,
    pub show_services_dialog: State<bool>,
    pub services_data: State<Option<eiva_view::ServiceListData>>,
    pub show_engines_dialog: State<bool>,
    pub engines_data: State<Option<eiva_view::EnginesPanelData>>,
    pub engines_cursor: State<usize>,
    pub show_cron_dialog: State<bool>,
    pub cron_data: State<Option<eiva_view::CronPanelData>>,
    pub show_memory_dialog: State<bool>,
    pub memory_data: State<Option<eiva_view::MemoryPanelData>>,
    pub show_mcp_dialog: State<bool>,
    pub mcp_data: State<Option<eiva_view::McpPanelData>>,
    pub show_channels_dialog: State<bool>,
    pub channels_data: State<Option<eiva_view::ChannelsPanelData>>,
    pub show_analytics_dialog: State<bool>,
    pub analytics_data: State<Option<eiva_view::AnalyticsPanelData>>,
    pub show_logs_dialog: State<bool>,
    pub logs_data: State<Option<eiva_view::LogsPanelData>>,
}
