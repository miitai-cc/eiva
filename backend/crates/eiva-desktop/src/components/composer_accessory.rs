...
//! selector. These are Eiva-specific affordances the generic chat crate
...
pub struct ComposerAccessoryProps {
    ...
    pub directory_selector: eiva_view::DirectorySelectorState,
...
struct DirectorySelectorBarProps {
    state: eiva_view::DirectorySelectorState,
