...
//! `ChatSurface` component (embedded mode), plus Eiva's empty state and the
...
pub struct ChatProps {
    ...
    pub bottom_bar: eiva_view::BottomBarData,
...
pub fn Chat(props: ChatProps) -> Element {
    ...
    let controls = ChatControls {
        ...
        placeholder: eiva_view::ComposerData::PLACEHOLDER.to_string(),
...
fn EmptyState(props: EmptyStateProps) -> Element {
    ...
    let data = eiva_view::EmptyStateData {
